    ...
    return (
        <>
            ...
            <div class="inner">
                <ul class="tiles">
                    <li>
                        <img src={require("../src/img/최종원.jpg").default} />
                        <h3>최종원 교수</h3>
                        <p>choejn@sm.ac.kr</p>
                    ...
                    <li>
                    <img src={require("../src/img/이광수.jpg").default} />
                        <h3>이광수 교수</h3>
                        <p>rhee@sm.ac.kr</p>
                    ...
                    <li>
                    <img src={require("../src/img/김주균.jpg").default} />
                        <h3>김주균 교수</h3>
                        <p>jgkim@sm.ac.kr</p>
                    ...
                    <li>
                    <img src={require("../src/img/문봉희.jpg").default} />
                        <h3>문봉희 교수</h3>
                        <p>rhee@sm.ac.kr</p>
                    ...
                    <li>
                    <img src={require("../src/img/창병모.jpg").default} />
                        <h3>창병모 교수</h3>
                        <p>chang@sm.ac.kr</p>
                    ...
                    <li>
                    <img src={require("../src/img/최영우.jpg").default} />
                        <h3>최영우 교수</h3>
                        <p>ywchoi@sm.ac.kr</p>
                    ...
                    <li>
                    <img src={require("../src/img/심준호.jpg").default} />
                        <h3>심준호 교수</h3>
                        <p>jshim@sm.ac.kr</p>
                    ...
                    <li>
                    <img src={require("../src/img/김윤희.jpg").default} />
                        <h3>김윤희 교수</h3>
                        <p>yulan@sm.ac.kr</p>
                    ...
                    <li>
                        <img src={require("../src/img/유석종.jpg").default} />
                        <h3>유석종 교수</h3>
                        <p>sjyu@sm.ac.kr</p>
                    ...
                    <li>
                        <img src={require("../src/img/이기용.jpg").default} />
                        <h3>이기용 교수</h3>
                    ...
                    <li>
                        <img src={require("../src/img/김윤진.jpg").default} />
                        <h3>김윤진 교수</h3>
                        <p>jshim@sm.ac.kr</p>
                    ...
                    <li>
                        <img src={require("../src/img/박영훈.jpg").default} />
                        <h3>박영훈 교수</h3>
                    ...
                    <li>
                        <img src={require("../src/img/채희준.jpg").default} />
                        <h3>채희준 교수</h3>
                    ...
                    <li>
                        <img src={require("../src/img/정영주.jpg").default} />
                        <h3>정영주 교수</h3>
                        <p>yjeong@sm.ac.kr</p>
                    ...
                    <li>
                        <img src={require("../src/img/박동철.jpg").default} />
                        <h3>박동철 교수</h3>
                        <p>dpark@sm.ac.kr</p>
                    ...
                    <li>
                        <img src={require("../src/img/박숙영.jpg").default} />
                        <h3>박숙영 교수</h3>
                        <p>blue@sm.ac.kr</p>
                    ...
                    <li>
                        <img src={require("../src/img/이현자.jpg").default} />
                        <h3>이현자 교수</h3>
                    ...
                    <li>
                        <img src={require("../src/img/박재년.jpg").default} />
                        <h3>박재년 명예교수</h3>
                        <p>jnpark@sm.ac.kr</p>
